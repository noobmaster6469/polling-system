  ...
  return (
    <div className="flex">
      <div className="w-screen h-screen md:w-1/2 px-12 pt-8 pb-12">
        <h2 className="text-lg font-semibold text-black">Polling App</h2>
        {children}
      </div>
      <div className="hidden md:block w-1/2 h-screen bg-sky-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden relative">
        <img
          src={UI_ELEMENT}
          className="w-[50%] absolute rotate-180 right-0 top-14"
        />
        <img
          src={UI_ELEMENT}
          className="w-[50%] absolute  left-0 bottom-[20%]"
        />

        <img
          src={CARD_1}
          className="w-72  lg:w-80 absolute top-[8%] left-[10%] shadow-lg shadow-blue-400/15"
        />
        <img
          src={CARD_2}
          className="w-72  lg:w-80 absolute top-[34%] right-[20%] shadow-lg shadow-blue-400/15"
        />
        <img
          src={CARD_3}
          className="w-72  lg:w-80 absolute top-[70%] left-[10%] shadow-lg shadow-blue-400/15"
        />
      </div>
    </div>
  );
